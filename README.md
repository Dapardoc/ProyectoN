...
repor para taller Dian
https://github.com/OmarVasquez/caption-this-dian1.git

El origin indica el remoto

Crear branch con usuario
Crear carpeta local para trabajar
git clone url
git switch
modificr un archivo readme
git status
añadir al stage git add
git commit 
git push
